...
const { createHotel, createHotelRoom, getHotelRooms, uploadHotelPictures, updateHotel, deleteHotel, getHotelDetails, getAllHotels } = require('../controllers/hotel.controller');
