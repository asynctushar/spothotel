                ...
                <div className="mx-auto px-4 md:px-10 lg:px-20 xl:px-48 mt-4">
                    <div className="px-1 sm:px-3">
                        ...
                        <div className="ml-8 flex items-center mb-4">
                            ...
                            <input value={name} onChange={(e) => setName(e.target.value)} id="name" type="text" className="outline-none py-2 px-1 sm:px-2 rounded-md border border-solid border-gray-400 text-gray-700 font-mono" />
                        </div>
                        <div className="ml-8 flex items-center mb-4">
