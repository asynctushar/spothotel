...
import AdminBookingDetailsLoader from '@/components/booking/AdminBookingDetailsLoader';
...
const BookingDetails = () => {
    ...
    const { isLoading, data } = useBookingQuery(id);
    ...
    return (
        <Fragment>
            <Meta
                title={data?.booking ? `Booking Details #${data?.booking._id}` : isLoading ? "Booking Details" : "Booking Not Found"}
                description="View detailed information about a specific hotel booking including customer, room, and payment details."
                keywords="booking details, reservation details, SpotHotel admin"
            />
            {isLoading ? <AdminBookingDetailsLoader /> : !data?.booking ? (
                ...
                <div className="min-h-[calc(100vh-72px)] bg-background pb-16">
                    <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <Link to="/admin/bookings" className="inline-flex items-center gap-2 text-primary hover:underline mb-6">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-foreground/75 mt-2">View individual booking information</p>
                        </div>
